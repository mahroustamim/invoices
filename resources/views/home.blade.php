							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{ \App\Models\Invoice::where('value_status', 1)->sum('total') }}
											</h4>
											<p class="mb-0 tx-12 text-white op-7">{{ \App\Models\Invoice::where('value_status', 1)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<span class="text-white op-7">
												 {{ round(\App\Models\Invoice::where('value_status', 1)->count() /  \App\Models\Invoice::count()  * 100, 1)  }}
											</span>
										</span>
									</div>
								</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{ \App\Models\Invoice::where('value_status', 2)->sum('total') }}
											</h4>
											<p class="mb-0 tx-12 text-white op-7">{{ \App\Models\Invoice::where('value_status', 2)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<span class="text-white op-7"> 
												{{ round(\App\Models\Invoice::where('value_status', 2)->count() /  \App\Models\Invoice::count()  * 100, 1)  }}
											</span>
										</span>
									</div>
								</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">
												{{ \App\Models\Invoice::where('value_status', 3)->sum('total') }}
											</h4>
											<p class="mb-0 tx-12 text-white op-7">{{ \App\Models\Invoice::where('value_status', 3)->count() }}</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<span class="text-white op-7">
												{{ round(\App\Models\Invoice::where('value_status', 3)->count() /  \App\Models\Invoice::count()  * 100, 1)  }}
											</span>
										</span>
									</div>
								</div>
				...
				<div class="row row-sm">
						...
						<div class="card">
							<div class="card-header bg-transparent pd-b-0 pd-t-20 bd-b-0">
								<div class="d-flex justify-content-between">
									<h4 class="card-title mb-0">نسبة عدد الفواتير</h4>
								</div>
							</div>
					...
					<div class="col-lg-12 col-xl-5">
						<div class="card card-dashboard-map-one">
							<label class="main-content-label">نسبة قيمة المال</label>
							<div class="">
								{!! $pie->render() !!}
							</div>
						</div>
