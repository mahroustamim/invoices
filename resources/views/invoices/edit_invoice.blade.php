        ...
        <form action="{{ route('invoices.update', $invoice->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-4 mb-3">
                    ...
                    <input class="form-control @error('invoice_number') is-invalid @enderror" type="text" name="invoice_number"  id="invoice_number" value="{{ $invoice->invoice_number }}">
                ...
                <div class="col-12 col-sm-6 col-lg-4 mb-3">
                    ...
                    <input class="form-control @error('invoice_date') is-invalid @enderror" type="date" name="invoice_date"  id="invoice_Date"  value="{{ $invoice->invoice_date }}" >
                    @error('invoice_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-12 col-sm-6 col-lg-4 mb-3">
                    ...
                    <input class="form-control @error('due_date') is-invalid @enderror" type="date" name="due_date" @error('due_date') is-invalid @enderror id="due_date" placeholder="YYYY-MM-DD" value="{{ $invoice->due_date }}">
                    @error('due_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-12 col-sm-6 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control @error('amount_collection') is-invalid @enderror" id="amount_collection" name="amount_collection" value="{{ $invoice->amount_collection }}">
                ...
                <div class="col-12 col-sm-6 col-lg-4 mb-3">
                    ...
                    <input class="form-control @error('amount_commission') is-invalid @enderror" type="text" name="amount_commission" id="amount_commission" value="{{ $invoice->amount_commission }}">
